...
LOOT_TYPES = {
    ...
    "waypoint": {"name": "Waypoint", "emoji": "\U0001f4cd", "description": "Places you meant to return to. You won't, but it's nice to know they're there."},
...
VAULT_DIR_TO_LOOT = {
    ...
    "Browser": "footprint", "Safari": "footprint", "Maps": "footprint",
    "Bookmarks": "waypoint",
    "Photos": "memory_shard",
